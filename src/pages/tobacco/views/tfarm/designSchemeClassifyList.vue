  ...
  <div class='mainPanel'>
    ...
    <main class='contentPanel'>
      <el-table highlight-current-row
                ...
                :data="formData.designSchemeClassifyList"
                style="width: 100%"
        ...
        <el-table-column prop="name"
                         :label="this.$t('tobacco.tfarm.designSchemeClassify.name')" />
        <el-table-column prop="position"
                         :label="this.$t('tobacco.tfarm.designSchemeClassify.position')" />
        <el-table-column prop="desc"
                         :label="this.$t('tobacco.tfarm.designSchemeClassify.desc')" />
...
export default {
  ...
  methods: {
    ...
    deleteButtonClick() {
      ...
      Promise.all([
        designSchemeClassifyApi.deleteDesignSchemeClassify(
    ...
    onSearchButtonClick() {
      Promise.all([
        ...
        .then(([response]) => {
          this.formData.designSchemeClassifyList = response.content;
