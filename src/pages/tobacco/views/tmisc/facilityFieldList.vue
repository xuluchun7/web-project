  ...
  <div class='mainPanel'>
    ...
    <main class='contentPanel'>
      <el-table highlight-current-row
                ...
                :data="formData.facilityFieldList"
                style="width: 100%"
        ...
        <el-table-column prop="name"
                         :label="this.$t('tobacco.tmisc.facilityField.name')" />
        <el-table-column prop="visible"
                         :label="this.$t('tobacco.tmisc.facilityField.visible')">
          <template slot-scope="scope">
            {{scope.row.visible==true?"可见":"不可见"}}
          </template>
        </el-table-column>
        <el-table-column prop="position"
                         :label="this.$t('tobacco.tmisc.facilityField.position')" />
        <el-table-column prop="desc"
                         :label="this.$t('tobacco.tmisc.facilityField.desc')" />
...
<script>
const AddForm = () => import("./facilityFieldAdd.vue");
const EditForm = () => import("./facilityFieldEdit.vue");
...
export default {
  ...
  methods: {
    ...
    deleteButtonClick() {
      ...
      Promise.all([
        facilityFieldApi.deleteFacilityField(this.formData.selectRow.id)
      ])
        .then(([response]) => {
          this.$message({
            type: "info",
    ...
    onSearchButtonClick() {
      Promise.all([
        ...
        .then(([response]) => {
          this.formData.facilityFieldList = response.content;
