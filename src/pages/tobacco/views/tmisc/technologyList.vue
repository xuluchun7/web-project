	  ...
	  <main class='contentPanel'>
		<el-table
		  ...
		  <el-table-column type="index">
			    ...
			    <el-table-column prop="code" :label="this.$t('misc.tmisc.technology.code')" />
			    <el-table-column prop="annual" :label="this.$t('misc.tmisc.technology.annual')" />
			    <el-table-column prop="name" :label="this.$t('misc.tmisc.technology.name')" />
			    <el-table-column prop="author" :label="this.$t('misc.tmisc.technology.author')" />
			    <el-table-column prop="date" :label="this.$t('misc.tmisc.technology.date')" />
			    <el-table-column prop="control" :label="this.$t('misc.tmisc.technology.control')" />
			    <el-table-column prop="type" :label="this.$t('misc.tmisc.technology.type')" />
		<el-table-column
		fixed="right"
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            onSearchButtonClick(){
                Promise.all([technologyApi.getAll({
