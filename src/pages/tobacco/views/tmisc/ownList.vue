  ...
  <div class='mainPanel'>
    ...
    <main class='contentPanel'>
      ...
      >
        ...
        <el-table-column
          prop="name"
          :label="this.$t('tobacco.tmisc.own.name')"
        />
        <el-table-column
          prop="entry"
          :label="this.$t('tobacco.tmisc.own.entry')"
        />
        <el-table-column
          prop="visible"
          :label="this.$t('tobacco.tmisc.own.visible')"
        >
        ...
        <el-table-column
          prop="position"
          :label="this.$t('tobacco.tmisc.own.position')"
        />
        <el-table-column
          prop="desc"
          :label="this.$t('tobacco.tmisc.own.desc')"
        />
        <el-table-column
          fixed="right"
...
<script>
const AddForm = () => import('./ownAdd.vue');
const EditForm = () => import('./ownEdit.vue');
...
export default {
  ...
  methods: {
    ...
    deleteButtonClick() {
      ...
      Promise.all([ownApi.deleteOwn(this.formData.selectRow.id)])
        .then(([response]) => {
          this.$message({
            type: 'info',
    ...
    onSearchButtonClick() {
      Promise.all([
        ownApi.getAll({
          ...
          contains: 'name,entry,visible,position,desc,:{keyword}:true'.format({
            keyword: this.formData.pagination.keyword
          }),
          search: 'name:EQ:{name};entry:EQ:{entry};visible:EQ:{visible};position:EQ:{position};desc:EQ:{desc};'.format(
            {
        ...
        .then(([response]) => {
          this.formData.ownList = response.content;
