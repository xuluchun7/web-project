      ...
      <div class='queryCriteria'>
        <el-form inline>
          ...
          <el-form-item :label="$t('tobacco.tstorage.transportInventory.inventoryId')">
            <el-input v-bind:placeholder="$t('base.pleaseInput')"
                      v-model="searchData.inventoryId"
                      @keyup.enter.native="onSearchButtonClick" />
          </el-form-item>
    ...
    <main class='contentPanel'>
      <el-table highlight-current-row
        ...
        <el-table-column prop="transportId"
                         :label="this.$t('tobacco.tstorage.transportInventory.transportId')" />
        <el-table-column prop="inventoryId"
                         :label="this.$t('tobacco.tstorage.transportInventory.inventoryId')" />
        <el-table-column prop="weight"
                         :label="this.$t('tobacco.tstorage.transportInventory.weight')" />
        <el-table-column prop="desc"
                         :label="this.$t('tobacco.tstorage.transportInventory.desc')" />
...
export default {
  ...
  methods: {
    ...
    deleteButtonClick() {
      ...
      Promise.all([
        transportInventoryApi.deleteTransportInventory(
    ...
    onSearchButtonClick() {
      Promise.all([
        transportInventoryApi.getAll({
          size: this.formData.pagination.pageSize,
          page: this.formData.pagination.currentPage - 1,
          sort: "id,ASC",
          contains: "transportId,inventoryId,weight,desc,:{keyword}:true".format(
