<template>
  <el-form :model="formItem"
    ...
    <el-form-item :label="$t('tobacco.tstorage.inventory.serial')"
                  prop="barcode">
    ...
    <el-form-item label="件数"
                  prop="amount">
      <el-input-number v-model="formItem.amount"
                       style="width: 100%;"
...
export default {
  data() {
    return {
      ...
      ruleValidate: {
        barcode: [{ required: true, message: "编码不能为空", trigger: "blur" }]
      }
    };
  },
  created() {},
  ...
  methods: {
    getWeightAndAmount() {
      Promise.all([
        inventoryApi.getStandardWeightAndUnpackWeight(
          this.formItem.typeId,
          this.formItem.varietyId,
          this.formItem.gradeId,
