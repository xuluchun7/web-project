  ...
  <div class='mainPanel'>
      ...
      <div class='queryCriteria'>
        <el-form inline>
          ...
          <el-form-item :label="$t('tobacco.tstorage.stock.accountSet')">
            <el-select v-model="searchData.booksId"
                       clearable>
          ...
          <el-row>
            <template v-if='expand'>
              <el-form-item :label="this.$t('tobacco.tstorage.region.whouseId')">
                <el-select v-model="searchData.warehouse"
                           clearable
                           @change="getRegion">
              ...
              <el-form-item :label="$t('tobacco.tstorage.facility.regionId')">
                <el-select v-model="searchData.region"
                           clearable
                           @change="getStack()">
              ...
              <el-form-item :label="$t('tobacco.tstorage.stack.stackId')"
                            prop="stack">
                <el-select v-model="formItem.stack"
                           clearable
                           style="width: 100%;">
              ...
              <el-form-item :label="$t('tobacco.tsell.invoice.statusName')">
                <status-select :label.sync="searchData.statusName"
    ...
    <main class='contentPanel'>
      <el-table highlight-current-row
        ...
        <el-table-column prop="booksId"
                         :label="this.$t('tobacco.tstorage.stock.accountSet')"
                         width="100"
                         show-overflow-tooltip>
        ...
        <el-table-column prop="region.title"
                         :label="this.$t('tobacco.tstorage.facility.regionId')"
                         width="100"
                         show-overflow-tooltip />
        <el-table-column prop="stack.name"
                         label="垛位"
                         width="100"
                         show-overflow-tooltip />
        <el-table-column prop="annual"
                         :label="this.$t('tobacco.tstorage.stock.annual')" />
        <el-table-column prop="serial"
                         :label="this.$t('tobacco.tstorage.stock.serial')"
                         width="100"
                         show-overflow-tooltip />
        <el-table-column prop="year"
                         :label="this.$t('tobacco.tstorage.stock.year')" />
        <el-table-column prop="month"
                         :label="this.$t('tobacco.tstorage.stock.month')" />
        ...
        <el-table-column prop="typeName"
                         :label="this.$t('tobacco.tstorage.stock.typeName')"
                         width="100"
                         show-overflow-tooltip />
        <el-table-column prop="statusName"
                         :label="this.$t('tobacco.tstorage.stock.statusName')"
                         width="100"
                         show-overflow-tooltip />
        <el-table-column prop="varietyName"
                         :label="this.$t('tobacco.tstorage.stock.varietyName')"
                         width="100"
                         show-overflow-tooltip />
        <el-table-column prop="rankName"
                         :label="this.$t('tobacco.tstorage.stock.rankName')"
                         width="100"
                         show-overflow-tooltip />
        <el-table-column prop="gradeName"
                         :label="this.$t('tobacco.tstorage.stock.gradeName')"
                         width="100"
                         show-overflow-tooltip />
        <el-table-column prop="standard"
                         :label="this.$t('tobacco.tstorage.stock.standard')">
          <template slot-scope="scope">
        ...
        <el-table-column prop="amount"
                         :label="this.$t('tobacco.tstorage.stock.amount')"
                         width="100"
                         show-overflow-tooltip>
        </el-table-column>
        <el-table-column prop="weight"
                         :label="this.$t('tobacco.tstorage.stock.weight')"
                         width="100"
                         show-overflow-tooltip />
        <el-table-column prop="desc"
                         :label="this.$t('tobacco.tstorage.stock.desc')"
                         width="100"
                         show-overflow-tooltip />
    ...
    onSearchButtonClick() {
      Promise.all([
        stockApi.getAll({
          ...
          sort: "serial,ASC",
          contains: "annual,serial,year,month,countryName,year,typeId,typeName,statusId,statusName,varietyId,varietyName,rankId,rankName,gradeId,gradeCode,gradeName,standard,amount,weight,desc,:{keyword}:true".format(
