<template>
  <el-form :model="formItem"
    ...
    <el-form-item :label="$t('tobacco.tstorage.operationFromTo.warehouseName')">
      <whouse-select :value.sync="formItem.warehouseId"
                     :label.sync="formItem.warehouseName"
    ...
    <el-form-item :label="$t('tobacco.tstorage.operationFromTo.threeOrganizationName')">
      <organization-form :root="threeOrgId"
                         @onchange="threeOrganizationOnchange"
                         style="width:100%" />
    </el-form-item>
    <el-form-item :label="$t('tobacco.tstorage.operationFromTo.threeWarehouseName')">
      <whouse-select :value.sync="formItem.threeWarehouseId"
                     :label.sync="formItem.threeWarehouseName"
