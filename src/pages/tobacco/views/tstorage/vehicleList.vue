    ...
    <main class='contentPanel'>
      <el-table highlight-current-row
        ...
        <el-table-column prop="license"
                         :label="this.$t('tobacco.tstorage.vehicle.license')"
                         min-width="100"
                         show-overflow-tooltip />
        <el-table-column prop="driver"
                         :label="this.$t('tobacco.tstorage.vehicle.driver')"
                         min-width="100"
                         show-overflow-tooltip />
        <el-table-column prop="legalPerson"
                         :label="this.$t('tobacco.tstorage.vehicle.legalPerson')"
                         min-width="100"
                         show-overflow-tooltip />
        <el-table-column prop="mobile"
                         :label="this.$t('tobacco.tstorage.vehicle.mobile')"
                         min-width="100"
                         show-overflow-tooltip />
        <el-table-column prop="displacement"
                         :label="this.$t('tobacco.tstorage.vehicle.displacement')"
                         min-width="100"
                         show-overflow-tooltip />
        <el-table-column prop="capacity"
                         :label="this.$t('tobacco.tstorage.vehicle.capacity')"
                         min-width="100"
                         show-overflow-tooltip />
        <el-table-column prop="listingDate"
                         :label="this.$t('tobacco.tstorage.vehicle.listingDate')"
                         min-width="100"
                         show-overflow-tooltip>
          <template slot-scope="scope">
            {{scope.row.listingDate|parseDate('YYYY-MM-DD')}}
          </template>
        </el-table-column>
    ...
    onSearchButtonClick() {
      Promise.all([
        vehicleApi.getAll({
          ...
          contains: "license,driver,legalPerson,displacement,capacity:{keyword}:true".format(
