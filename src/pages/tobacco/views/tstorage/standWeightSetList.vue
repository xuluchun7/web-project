    ...
    <main class='contentPanel'>
      <el-table highlight-current-row
        ...
        <el-table-column prop="tobaccoYear"
                         :label="this.$t('tobacco.tstorage.standWeightSet.tobaccoYear')"
                         width="100"
                         show-overflow-tooltip />
        <el-table-column prop="businessYear"
                         :label="this.$t('tobacco.tstorage.standWeightSet.businessYear')" />
        <el-table-column prop="typeName"
                         :label="this.$t('tobacco.tstorage.standWeightSet.typeName')"
                         width="100"
                         show-overflow-tooltip />
        <el-table-column prop="statusName"
                         :label="this.$t('tobacco.tstorage.standWeightSet.statusName')"
                         width="100"
                         show-overflow-tooltip />
        <el-table-column prop="varietyName"
                         :label="this.$t('tobacco.tstorage.standWeightSet.varietyName')"
                         width="100"
                         show-overflow-tooltip />
        <el-table-column prop="rankName"
                         :label="this.$t('tobacco.tstorage.standWeightSet.rankName')"
                         width="130"
                         show-overflow-tooltip />
        <el-table-column prop="gradeName"
                         :label="this.$t('tobacco.tstorage.standWeightSet.gradeName')"
                         width="100"
                         show-overflow-tooltip />
        <el-table-column prop="weight"
                         :label="this.$t('tobacco.tstorage.standWeightSet.weight')" />
        <el-table-column prop="upperWeight"
                         :label="this.$t('tobacco.tstorage.standWeightSet.upperWeight')"
                         width="100"
                         show-overflow-tooltip />
        <el-table-column prop="lowerWeight"
                         :label="this.$t('tobacco.tstorage.standWeightSet.lowerWeight')" />
        <el-table-column prop="desc"
                         :label="this.$t('tobacco.tstorage.standWeightSet.desc')"
                         width="100"
                         show-overflow-tooltip />
...
export default {
  ...
  methods: {
    ...
    deleteButtonClick() {
      ...
      Promise.all([
        standWeightSetApi.deleteStandWeightSet(this.formData.selectRow.id)
      ])
        .then(([response]) => {
          this.$message({
            type: "info",
    ...
    onSearchButtonClick() {
      ...
      Promise.all([
        standWeightSetApi.getAll({
          size: this.formData.pagination.pageSize,
          page: this.formData.pagination.currentPage - 1,
          sort: "id,ASC",
          contains: "weight,desc,:{keyword}:true".format({
