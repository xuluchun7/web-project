    ...
    <main class='contentPanel'>
      <el-table highlight-current-row
        ...
        <el-table-column prop="samGradeName"
                         ...
                         width="100"
                         show-overflow-tooltip />
        <el-table-column prop="qualifiedAmount"
                         label="合格件数"
                         width="100"
                         show-overflow-tooltip />
        <el-table-column prop="qualifiedWeight"
                         label="合格重量"
                         width="100"
                         show-overflow-tooltip />
        ...
        <el-table-column prop="moisture"
                         ...
                         width="100"
                         show-overflow-tooltip />
        <el-table-column prop="qualifiedPass"
                         label="合格率"
                         width="100"
                         show-overflow-tooltip />
        <el-table-column prop="unused"
                         label="无使用"
                         width="100"
                         show-overflow-tooltip />
        ...
        Promise.all([billCheckApi.getItem(this.formData.selectRow.id)])
          .then(([response]) => {
            ...
            if (this.dataLength <= 1) {
              ...
              this.tableHeight2 =
                this.tableHeight2 + 45 * (this.dataLength - 1);
            } else {
            ...
            if (this.expand2 === true) {
              ...
              if (this.dataLength <= 2) {
                ...
                this.tableHeight =
                  this.tableHeight + 45 * (5 - this.dataLength);
              }
            }
