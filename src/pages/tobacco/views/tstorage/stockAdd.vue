  ...
  <el-form :model="formItem"
    ...
    <el-row>
      <el-col :span="12">
        <el-form-item :label="$t('tobacco.tstorage.stock.accountSet')"
                      prop="booksId">
          <el-select v-model="formItem.booksId"
                     style="width: 100%"
                     disabled>
      ...
      <el-col :span="12">
        <el-form-item :label="$t('tobacco.tstorage.stock.annual')"
                      prop="annual">
      ...
      <el-col :span="12">
        <el-form-item :label="$t('tobacco.tstorage.stock.year')"
                      prop="year">
          <el-date-picker value-format="yyyy"
      ...
      <el-col :span="12">
        <el-form-item :label="$t('tobacco.tstorage.stock.month')"
                      prop="month">
      ...
      <el-col :span="12">
        <el-form-item :label="$t('tobacco.tstorage.stock.tobaccoYear')"
                      prop="tobaccoYear">
          <el-date-picker value-format="yyyy"
    ...
    <el-row>
      <el-col :span="24">
        <el-col :span="12"
                style="height: 47px;">
          <el-form-item :label="$t('tobacco.tstorage.stock.standard')"
                        prop="standard">
            <el-switch v-model="formItem.standard"
                       @change="standardChange"></el-switch>
          </el-form-item>
        </el-col>
      </el-col>
    </el-row>
    <el-row>
      <el-col :span="12"
              style="height: 47px;">
        <el-form-item :label="$t('tobacco.tstorage.stock.amount')"
                      prop="amount">
      ...
      <el-col :span="12"
              style="height: 47px;">
        <el-form-item :label="$t('tobacco.tstorage.stock.weight')"
                      prop="weight">
          <el-input-number :min="minWeight"
    ...
    <el-form-item :label="$t('tobacco.tstorage.stock.desc')"
                  prop="desc">
