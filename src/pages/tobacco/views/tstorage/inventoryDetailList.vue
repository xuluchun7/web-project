      ...
      <div class='queryCriteria'>
        <el-form inline>
          ...
          <el-form-item :label="$t('casit.tstorage.inventoryDetail.farmerIdentity')">
            <el-input v-bind:placeholder="$t('base.pleaseInput')"
                      v-model="searchData.farmerIdentity"
                      @keyup.enter.native="onSearchButtonClick" />
          </el-form-item>
    ...
    <main class='contentPanel'>
      <el-table highlight-current-row
        ...
        <el-table-column prop="detailId"
                         :label="this.$t('casit.tstorage.inventoryDetail.detailId')" />
        <el-table-column prop="title"
                         :label="this.$t('casit.tstorage.inventoryDetail.title')" />
        <el-table-column prop="countryId"
                         :label="this.$t('casit.tstorage.inventoryDetail.countryId')" />
        <el-table-column prop="countryName"
                         :label="this.$t('casit.tstorage.inventoryDetail.countryName')" />
        <el-table-column prop="contractId"
                         :label="this.$t('casit.tstorage.inventoryDetail.contractId')" />
        <el-table-column prop="contractNumber"
                         :label="this.$t('casit.tstorage.inventoryDetail.contractNumber')" />
        <el-table-column prop="contractCard"
                         :label="this.$t('casit.tstorage.inventoryDetail.contractCard')" />
        <el-table-column prop="farmerId"
                         :label="this.$t('casit.tstorage.inventoryDetail.farmerId')" />
        <el-table-column prop="farmerNumber"
                         :label="this.$t('casit.tstorage.inventoryDetail.farmerNumber')" />
        <el-table-column prop="farmerName"
                         :label="this.$t('casit.tstorage.inventoryDetail.farmerName')" />
        <el-table-column prop="farmerIdentity"
                         :label="this.$t('casit.tstorage.inventoryDetail.farmerIdentity')" />
        <el-table-column prop="unpackWeight"
                         :label="this.$t('casit.tstorage.inventoryDetail.unpackWeight')" />
        <el-table-column prop="weight"
                         :label="this.$t('casit.tstorage.inventoryDetail.weight')" />
        <el-table-column prop="basket"
                         :label="this.$t('casit.tstorage.inventoryDetail.basket')" />
        <el-table-column prop="content"
                         :label="this.$t('casit.tstorage.inventoryDetail.content')" />
        <el-table-column prop="desc"
                         :label="this.$t('casit.tstorage.inventoryDetail.desc')" />
...
export default {
  ...
  methods: {
    ...
    deleteButtonClick() {
      ...
      Promise.all([
        inventoryDetailApi.deleteInventoryDetail(this.formData.selectRow.id)
      ])
        .then(([response]) => {
          this.$message({
            type: "info",
    ...
    onSearchButtonClick() {
      Promise.all([
        inventoryDetailApi.getAll({
          size: this.formData.pagination.pageSize,
          page: this.formData.pagination.currentPage - 1,
          sort: "id,ASC",
          contains: "detailId,title,countryId,countryName,contractId,contractNumber,contractCard,farmerId,farmerNumber,farmerName,farmerIdentity,weight,basket,content,desc,:{keyword}:true".format(
