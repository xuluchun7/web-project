<template>
  <el-form :model="formItem"
    ...
    <el-row>
      <el-col :span="12">
        <el-form-item :label="$t('tobacco.tstorage.facility.serialno')"
                      prop="serialno">
      ...
      <el-col :span="12">
        <el-form-item :label="$t('tobacco.tstorage.facility.name')"
                      prop="name">
          <el-input v-bind:placeholder="$t('base.pleaseInput')"
    ...
    <el-row>
      <el-col :span="12">
        <el-form-item :label="$t('tobacco.tstorage.facility.type')"
                      prop="type">
          <el-select v-model="formItem.type"
                     style="width: 100%">
            <el-option v-for="item in formData.typeList"
                       :value="item.id"
                       :label="item.name"
                       :key="item.id">
            </el-option>
    ...
    <el-row>
      ...
      <el-col :span="12">
        <el-form-item :label="$t('tobacco.tstorage.facility.rfid1')"
                      prop="rfid1">
          <el-input v-bind:placeholder="$t('base.pleaseInput')"
                    v-model="formItem.rfid1" />
        </el-form-item>
      </el-col>
    </el-row>
    <el-row>
      <el-col :span="12">
        <el-form-item :label="$t('tobacco.tstorage.facility.rfid2')"
                      prop="rfid2">
          <el-input v-bind:placeholder="$t('base.pleaseInput')"
                    v-model="formItem.rfid2" />
        </el-form-item>
      </el-col>
      <el-col :span="12">
        <el-form-item :label="$t('tobacco.tstorage.facility.hrfid')"
                      prop="hrfid">
          <el-input v-bind:placeholder="$t('base.pleaseInput')"
                    v-model="formItem.hrfid" />
        </el-form-item>
      </el-col>
    </el-row>
    <el-row>
      <el-col :span="12">
        <el-form-item :label="$t('tobacco.tstorage.facility.num1')"
                      prop="num1">
          <el-input v-bind:placeholder="$t('base.pleaseInput')"
                    v-model="formItem.num1" />
        </el-form-item>
      </el-col>
      <el-col :span="12">
        <el-form-item :label="$t('tobacco.tstorage.facility.num2')"
                      prop="num2">
          <el-input v-bind:placeholder="$t('base.pleaseInput')"
                    v-model="formItem.num2" />
        </el-form-item>
      </el-col>
    </el-row>
    <el-row>
      <el-col :span="12">
        <el-form-item :label="$t('tobacco.tstorage.facility.tare')"
                      prop="tare">
          <el-input-number size="small"
                           v-bind:placeholder="$t('base.pleaseInput')"
                           v-model="formItem.tare"
                           style="width: 100%;" />
        </el-form-item>
      </el-col>
      <el-col :span="12">
        <el-form-item :label="$t('tobacco.tstorage.facility.capacityWeight')"
                      prop="">
    ...
    <el-row>
      <el-col :span="12">
        <el-form-item :label="$t('tobacco.tstorage.facility.capacityPack')"
                      prop="capacityPack">
      ...
      <el-col :span="12">
        <el-form-item :label="$t('tobacco.tstorage.facility.currentWeight')"
                      prop="currentWeight">
    ...
    <el-row>
      <el-col :span="12">
        <el-form-item :label="$t('tobacco.tstorage.facility.currentPack')"
                      prop="currentPack">
      ...
      <el-col :span="12">
        <el-form-item :label="$t('tobacco.tstorage.facility.valid')"
                      prop="valid">
          <el-switch v-model="formItem.valid"></el-switch>
        </el-form-item>
      </el-col>
    </el-row>
    <el-form-item :label="$t('tobacco.tstorage.facility.desc')"
                  prop="desc">
...
export default {
  ...
  created() {
    ...
    this.getWhouse();
    this.getRegion();
    Promise.all([categoryApi.getAll({ search: "lead:EQ:ST_FL" })])
      .then(([response]) => {
        this.controllist = response.content;
      })
      .catch(error => {});
    Promise.all([categoryApi.getAll({ search: "lead:EQ:ST_FT" })])
      .then(([response]) => {
  ...
  methods: {
    ...
    onSubmitClick(name) {
      this.$refs[name].validate(valid => {
        if (valid) {
          Promise.all([
            facilityApi.updateFacility(this.formItem.id, this.formItem)
          ])
            .then(([response]) => {
