        ...
        <el-form inline>
          ...
          <template v-if="expand">
            <el-form-item label="烟叶等级">
              <type-grade-select :typeId.sync="searchData.ttypeId"
                                 :typeName.sync="searchData.ttypeName"
                                 :gradeId.sync="searchData.tgradeId"
                                 :gradeName.sync="searchData.tgradeName"
      ...
      <div class='toolButton'
        ...
        <el-button-group>
          <el-button type='primary'
                     @click='onExpandClick'
                     style="height: 28px;">{{ $t('base.buttonFilter') }}<i :class="expandIcon"></i>
          </el-button>
          <el-button type='primary'
    ...
    <main>
      <el-table highlight-current-row
        ...
        <el-table-column prop="tyear"
                         :label="this.$t('tobacco.tstorage.billCheck.tyear')"
                         width="100"
                         show-overflow-tooltip />
        <el-table-column prop="ttypeName"
                         :label="this.$t('tobacco.tstorage.billCheck.ttypeName')"
                         width="100"
                         show-overflow-tooltip />
        <el-table-column prop="tstatusName"
                         :label="this.$t('tobacco.tstorage.billCheck.tstatusName')"
                         width="100"
                         show-overflow-tooltip />
        <el-table-column prop="tvarietyName"
                         :label="this.$t('tobacco.tstorage.billCheck.tvarietyName')"
                         width="100"
                         show-overflow-tooltip />
        <el-table-column prop="tgradeName"
                         :label="this.$t('tobacco.tstorage.billCheck.tgradeName')"
                         width="100"
                         show-overflow-tooltip />
        <el-table-column prop="trankName"
                         :label="this.$t('tobacco.tstorage.billCheck.trankName')"
                         width="100"
                         show-overflow-tooltip />
        <el-table-column prop="amount"
                         :label="this.$t('tobacco.tstorage.billCheck.amount')"
                         width="100"
                         show-overflow-tooltip />
        <el-table-column prop="weight"
                         :label="this.$t('tobacco.tstorage.billCheck.weight')"
                         width="100"
                         show-overflow-tooltip />
        <el-table-column prop="sample"
                         :label="this.$t('tobacco.tstorage.billCheck.sample')"
                         width="100"
                         show-overflow-tooltip />
        <el-table-column prop="qualified"
                         :label="this.$t('tobacco.tstorage.billCheck.qualified')"
                         width="100"
                         show-overflow-tooltip />
        ...
        <el-table-column prop="rate"
                         :label="this.$t('tobacco.tstorage.billCheck.rate')"
                         width="100"
                         show-overflow-tooltip />
        <el-table-column prop="desc"
                         :label="this.$t('tobacco.tstorage.billCheck.desc')"
                         width="100"
                         show-overflow-tooltip />
    ...
    <main class='contentPanel'>
      <el-table highlight-current-row
        ...
        <el-table-column prop="samAmount"
                         ...
                         width="100"
                         show-overflow-tooltip />
        <el-table-column prop="totalWeight2"
                         label="复检总重量"
                         width="100"
                         show-overflow-tooltip />
        ...
        <el-table-column fixed="right"
          ...
          <template slot-scope="scope">
            <el-button type="text"
                       size="small"
                       :disabled="cantEdit"
                       @click="detailEditButtonClick(scope.row,true)">
              {{$t('base.buttonEdit')}}
            </el-button>
            <el-button type="text"
                       size="small"
                       :disabled="cantEdit"
                       @click="copyButtonClick(scope.row,true)">
              复制
            </el-button>
            <el-button @click="detailDeleteButtonConfirm(scope.row,false)"
                       type="text"
                       size="small"
                       :disabled="cantEdit">
              {{$t('base.buttonDelete')}}
    ...
    <template>
      ...
      <el-dialog :title="$t('base.buttonEdit')"
        ...
        <edit-form2 :item.sync=formData.viewSelect2
                    :items.sync=formData.billRecheckItemList
        ...
        for (var j = 0, len2 = arr.length; j < len2; j++) {
          ...
          if (j === arr.length - 1) {
            if (gradeArr[i].samBundle < gradeArr[i].totalMount) {
              this.$message({
                message:
                  gradeArr[i].oriGradeName + "复检把数和超过了抽样总把数",
                type: "error",
                duration: 3000
              });
              return;
    ...
    onSearchButtonClick() {
      ...
      Promise.all([
        billCheckApi.getAll({
          ...
          contains: "tyear,ttypeId,ttypeName,tstatusId,tstatusName,tvarietyId,tvarietyName,tgradeId,tgradeCode,tgradeName,trankId,trankName,amount,weight,sample,qualified,rate,desc,:{keyword}:true".format(
          ...
          search: "organization.organizationId:rlike:{orgid};tyear:EQ:{tyear};ttypeId:EQ:{ttypeId};ttypeName:EQ:{ttypeName};tstatusId:EQ:{tstatusId};tstatusName:EQ:{tstatusName};tvarietyId:EQ:{tvarietyId};tvarietyName:EQ:{tvarietyName};tgradeId:EQ:{tgradeId};tgradeCode:EQ:{tgradeCode};tgradeName:EQ:{tgradeName};billType:EQ:Q201".format(
            {
              ...
              tyear:
                this.searchData.tyear === null ? "" : this.searchData.tyear,
