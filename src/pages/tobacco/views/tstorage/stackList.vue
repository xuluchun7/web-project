    ...
    <main class='contentPanel'>
      <el-table highlight-current-row
        ...
        <el-table-column prop="lead"
                         :label="this.$t('tobacco.tstorage.stack.lead')"
                         width="100"
                         show-overflow-tooltip />
        <el-table-column prop="leaf"
                         :label="this.$t('tobacco.tstorage.stack.leaf')">
        ...
        <el-table-column prop="number"
                         :label="this.$t('tobacco.tstorage.stack.number')"
                         width="100"
                         show-overflow-tooltip />
        <el-table-column prop="identity"
                         :label="this.$t('tobacco.tstorage.stack.identity')"
                         width="100"
                         show-overflow-tooltip />
        <el-table-column prop="name"
                         :label="this.$t('tobacco.tstorage.stack.name')"
                         width="100"
                         show-overflow-tooltip />
        <el-table-column prop="space"
                         :label="this.$t('tobacco.tstorage.stack.space')"
                         width="100"
                         show-overflow-tooltip />
        <el-table-column prop="capacity"
                         :label="this.$t('tobacco.tstorage.stack.capacity')"
                         width="100"
                         show-overflow-tooltip />
        <el-table-column prop="visible"
                         :label="this.$t('tobacco.tstorage.stack.visible')">
          <template slot-scope="scope">
        ...
        <el-table-column prop="position"
                         :label="this.$t('tobacco.tstorage.stack.position')"
                         width="100"
                         show-overflow-tooltip />
        <el-table-column prop="control.name"
                         :label="this.$t('tobacco.tstorage.stack.control')"
                         width="100"
                         show-overflow-tooltip />
        <el-table-column prop="desc"
                         :label="this.$t('tobacco.tstorage.stack.desc')"
                         width="100"
                         show-overflow-tooltip />
    ...
    onSearchButtonClick() {
      Promise.all([
        stackApi.getAll({
          ...
          sort: "id,ASC",
          contains: "lead,leaf,number,identity,name,space,capacity,visible,position,control,desc,:{keyword}:true".format(
