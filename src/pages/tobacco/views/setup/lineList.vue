    ...
    <main class='contentPanel'>
      <el-table highlight-current-row
        ...
        <el-table-column prop="id"
                         :label="$t('tobacco.setup.line.id')"
                         width="250"
                         show-overflow-tooltip />
        <el-table-column prop="name"
                         :label="$t('tobacco.setup.line.name')"
                         width="350"
                         show-overflow-tooltip />
        <el-table-column prop="visible"
                         :label="$t('tobacco.setup.line.visible')">
        ...
        <el-table-column prop="desc"
                         :label="$t('tobacco.setup.line.desc')"
                         width="350"
                         show-overflow-tooltip />
    ...
    onSearchButtonClick() {
      Promise.all([
        lineApi.getAll({
          ...
          contains: "id,name,visible,desc,:{keyword}:true".format({
