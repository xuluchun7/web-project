    ...
    <main class='contentPanel'>
      <el-table highlight-current-row
        ...
        <el-table-column prop="classify"
                         :label="this.$t('tobacco.setup.inventoryLifecycle.classify')" />
        <el-table-column prop="sort"
                         :label="this.$t('tobacco.setup.inventoryLifecycle.sort')" />
        <el-table-column prop="title"
                         :label="this.$t('tobacco.setup.inventoryLifecycle.title')" />
        <el-table-column prop="type.name"
                         :label="$t('tobacco.setup.inventoryLifecycle.type')" />
...
export default {
  ...
  methods: {
    ...
    deleteButtonClick() {
      ...
      Promise.all([
        inventoryLifecycleApi.deleteInventoryLifecycle(
