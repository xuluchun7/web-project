  ...
  <div class='mainPanel'>
    ...
    <main class='contentPanel'>
      <el-table highlight-current-row
                ...
                :data="formData.attributeList"
                style="width: 100%"
                :row-class-name="tableRowClassName">
        <el-table-column type="index">
        </el-table-column>
        <el-table-column prop="categoryId"
                         :label="this.$t('tobacco.setup.attribute.categoryId')" />
        <el-table-column prop="label"
                         :label="this.$t('tobacco.setup.attribute.label')"
                         width="100"
                         show-overflow-tooltip />
        <el-table-column prop="keyId"
                         :label="this.$t('tobacco.setup.attribute.keyId')"
                         width="130"
                         show-overflow-tooltip />
        <el-table-column prop="value"
                         :label="this.$t('tobacco.setup.attribute.value')"
                         width="250"
                         show-overflow-tooltip />
        ...
        <el-table-column prop="type"
                         :label="this.$t('tobacco.setup.attribute.type')" />
        <el-table-column prop="edit"
                         :label="this.$t('tobacco.setup.attribute.edit')"
                         width="70"
                         show-overflow-tooltip />
        <el-table-column :label="this.$t('tobacco.setup.attribute.visible')"
                         width="70">
        ...
        <el-table-column prop="position"
                         :label="this.$t('tobacco.setup.attribute.position')"
                         width="70"
                         show-overflow-tooltip />
        <el-table-column prop="desc"
                         :label="this.$t('tobacco.setup.attribute.desc')"
                         width="100"
                         show-overflow-tooltip />
