    ...
    <main class='contentPanel'>
      <el-table highlight-current-row
        ...
        <el-table-column prop="contractNumber"
                         :label="this.$t('tobacco.tsell.fertility.contractNumber')"
                         width="170"
                         show-overflow-tooltip />
        <el-table-column prop="contractName"
                         :label="this.$t('tobacco.tsell.fertility.contractName')"
                         width="100"
                         show-overflow-tooltip
                         fixed />
        <el-table-column prop="farmerPhone"
                         :label="this.$t('tobacco.tsell.fertility.farmerPhone')"
                         width="150"
                         show-overflow-tooltip />
        <el-table-column prop="farmerAddress"
                         :label="this.$t('tobacco.tsell.fertility.farmerAddress')"
                         width="200"
                         show-overflow-tooltip />
        <el-table-column prop="bankNo"
                         :label="this.$t('tobacco.tsell.fertility.bankNo')"
                         width="200"
                         show-overflow-tooltip />
        ...
        <el-table-column prop="weight"
                         :label="this.$t('tobacco.tsell.fertility.weight')"
                         width="100"
                         show-overflow-tooltip
                         fixed />
        <el-table-column prop="restWeight"
                         :label="this.$t('tobacco.tsell.fertility.restWeight')"
                         width="100"
                         show-overflow-tooltip />
        <el-table-column prop="date"
                         :label="this.$t('tobacco.tsell.fertility.date')"
                         width="170"
                         show-overflow-tooltip />
        <el-table-column prop="annual"
                         :label="this.$t('tobacco.tsell.fertility.annual')"
                         width="100"
                         show-overflow-tooltip />
        <el-table-column prop="author"
                         :label="this.$t('tobacco.tsell.fertility.author')"
                         width="100"
                         show-overflow-tooltip />
