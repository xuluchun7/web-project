<template>
  <el-form :model="formItem"
    ...
    <el-row>
      ...
      <el-col :span="12">
        <el-form-item :label="$t('tobacco.tsell.invoice.weight')"
                      prop="weight">
      ...
      <el-col :span="12">
        <el-form-item :label="$t('tobacco.tsell.invoice.tareWeight')"
                      prop="tareWeight">
          <el-input v-bind:placeholder="$t('base.pleaseInput')"
                    v-model="formItem.tareWeight" />
        </el-form-item>
      </el-col>
      <el-col :span="12">
        <el-form-item :label="$t('tobacco.tsell.invoice.mode')">
          <el-select v-model='testData.test'
                     style="width:100%;">
            <el-option v-for="item in  dateItem.modeList"
                       :key="item.id"
                       :label="item.name"
                       :value="item.id">
            </el-option>
