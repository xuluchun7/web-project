    ...
    <main class='contentPanel'>
      <el-table highlight-current-row
        ...
        <el-table-column prop="organization.districtName"
                         ...
                         width="200" />
        <el-table-column prop="recheckerName"
                         :label="this.$t('tobacco.tsell.preCheck.recheckerName')" />
        <el-table-column prop="recheckDate"
                         :label="this.$t('tobacco.tsell.preCheck.recheckDate')"
        ...
        <el-table-column prop="qualified"
                         :label="this.$t('tobacco.tsell.preCheck.qualified')">
          <template slot-scope="scope">
            {{scope.row.qualified===0?'合格':'不合格' }}
          </template>
        </el-table-column>
        <el-table-column prop="unqualifiedReason"
                         :label="this.$t('tobacco.tsell.preCheck.unqualifiedReason')" />
