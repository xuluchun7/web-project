  ...
  <div class='mainPanel'>
    ...
    <main class='contentPanel'>
      <el-table
        ...
        <el-table-column prop="id" :label="this.$t('tobacco.basic.pay.id')"/>
        <el-table-column prop="name" :label="this.$t('tobacco.basic.pay.name')"/>
        <el-table-column prop="desc" :label="this.$t('tobacco.basic.pay.desc')"/>
...
<script>
  import AddForm from './payAdd.vue';
  import EditForm from './payEdit.vue';
  ...
  export default {
    ...
    methods: {
      ...
      deleteButtonClick() {
        ...
        Promise.all([payApi.deletePay(this.formData.selectRow.id)])
          .then(([response]) => {
            this.$message({
              type: 'info',
