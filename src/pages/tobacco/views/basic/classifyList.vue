  ...
  <div class='mainPanel'>
    ...
    <main class='contentPanel'>
      <el-table
        ...
        :data="formData.classifyList"
        style="width: 100%"
        :row-class-name="tableRowClassName">
        <el-table-column
          type="index">
        </el-table-column>
        <el-table-column prop="id" :label="this.$t('tobacco.basic.classify.id')"/>
        <el-table-column prop="name" :label="this.$t('tobacco.basic.classify.name')"/>
        <el-table-column prop="visible" :label="this.$t('tobacco.basic.classify.visible')"/>
        <el-table-column prop="desc" :label="this.$t('tobacco.basic.classify.desc')"/>
...
<script>
  import AddForm from './classifyAdd.vue';
  import EditForm from './classifyEdit.vue';
  ...
  export default {
    ...
    methods: {
      ...
      deleteButtonClick() {
        ...
        Promise.all([classifyApi.deleteClassify(this.formData.selectRow.id)])
          .then(([response]) => {
            this.$message({
              type: 'info',
      ...
      onSearchButtonClick() {
        Promise.all([classifyApi.getAll({
