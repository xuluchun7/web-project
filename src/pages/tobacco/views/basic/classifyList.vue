    ...
    <main class='contentPanel'>
      <el-table highlight-current-row
        ...
        <el-table-column prop="id"
                         :label="this.$t('tobacco.basic.classify.id')" />
        <el-table-column prop="name"
                         :label="this.$t('tobacco.basic.classify.name')" />
        <el-table-column prop="visible"
                         :label="this.$t('tobacco.basic.classify.visible')" />
        <el-table-column prop="desc"
                         :label="this.$t('tobacco.basic.classify.desc')" />
