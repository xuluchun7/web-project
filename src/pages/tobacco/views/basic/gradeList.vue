  ...
  <div class='mainPanel'>
    ...
    <main class='contentPanel'>
      <el-table
        ...
        :data="formData.gradeList"
        style="width: 100%"
        :row-class-name="tableRowClassName">
        <el-table-column
          type="index">
        </el-table-column>
        <el-table-column prop="id" :label="this.$t('tobacco.basic.grade.id')"/>
        <el-table-column prop="code" :label="this.$t('tobacco.basic.grade.code')"/>
        <el-table-column prop="name" :label="this.$t('tobacco.basic.grade.name')"/>
        <el-table-column prop="type" :label="this.$t('tobacco.basic.grade.type')"/>
        <el-table-column prop="rankId" :label="this.$t('tobacco.basic.grade.rankId')"/>
        <el-table-column prop="partId" :label="this.$t('tobacco.basic.grade.partId')"/>
        <el-table-column prop="colorId" :label="this.$t('tobacco.basic.grade.colorId')"/>
        <el-table-column prop="classifyId" :label="this.$t('tobacco.basic.grade.classifyId')"/>
        <el-table-column prop="countryId" :label="this.$t('tobacco.basic.grade.countryId')"/>
        <el-table-column prop="visible" :label="this.$t('tobacco.basic.grade.visible')"/>
        <el-table-column prop="desc" :label="this.$t('tobacco.basic.grade.desc')"/>
...
<script>
  import AddForm from './gradeAdd.vue';
  import EditForm from './gradeEdit.vue';
  ...
  export default {
    ...
    methods: {
      ...
      deleteButtonClick() {
        ...
        Promise.all([gradeApi.deleteGrade(this.formData.selectRow.id)])
          .then(([response]) => {
            this.$message({
              type: 'info',
      ...
      onSearchButtonClick() {
        Promise.all([gradeApi.getAll({
          ...
          .then(([response]) => {
            this.formData.gradeList = response.content;
