    ...
    <main class='contentPanel'>
      <el-table highlight-current-row
        ...
        <el-table-column prop="annual"
                         :label="this.$t('tobacco.basic.price.annual')" />
        ...
        <el-table-column prop="organizationname"
                         :label="this.$t('tobacco.basic.price.organizationName')"
                         width="150"
                         show-overflow-tooltip />
        <el-table-column prop="type"
                         :label="this.$t('tobacco.basic.price.typeId')" />
        <el-table-column prop="variety"
                         :label="this.$t('tobacco.basic.price.varietyId')" />
        <el-table-column prop="gradename"
                         :label="this.$t('tobacco.basic.price.gradeName')" />
        <el-table-column prop="gradeid"
                         :label="this.$t('tobacco.basic.price.gradeId')" />
        <el-table-column prop="gradecode"
                         :label="this.$t('tobacco.basic.price.gradeCode')" />
        <el-table-column prop="pay"
                         :label="this.$t('tobacco.basic.price.payId')" />
        <el-table-column prop="area"
                         :label="this.$t('tobacco.basic.price.areaId')" />
        <el-table-column prop="status"
                         :label="this.$t('tobacco.basic.price.statusId')" />
        <el-table-column prop="supportfee"
                         :label="this.$t('tobacco.basic.price.supportFee')" />
        <el-table-column prop="subsidy"
                         :label="this.$t('tobacco.basic.price.subsidy')" />
        <!--<el-table-column prop="tax" :label="this.$t('tobacco.basic.price.tax')"/>-->
        <el-table-column prop="total"
                         :label="this.$t('tobacco.basic.price.total')" />
...
export default {
  ...
  methods: {
    checkDisabled(row) {
      if (
        row.organizationid.slice(0, 4) ===
        this.searchData.organizationId.slice(0, 4)
      ) {
        return false;
      } else {
        return true;
