  ...
  <div class='mainPanel'>
    ...
    <main class='contentPanel'>
      <el-table
        ...
        :data="formData.varietyList"
        style="width: 100%"
        :row-class-name="tableRowClassName">
        <el-table-column
          type="index">
        </el-table-column>
        <el-table-column prop="typeId" :label="this.$t('tobacco.basic.variety.typeId')"/>
        <el-table-column prop="varietyId" :label="this.$t('tobacco.basic.variety.varietyId')"/>
        <el-table-column prop="code" :label="this.$t('tobacco.basic.variety.code')"/>
        <el-table-column prop="name" :label="this.$t('tobacco.basic.variety.name')"/>
        <el-table-column prop="visible" :label="this.$t('tobacco.basic.variety.visible')"/>
        <el-table-column prop="desc" :label="this.$t('tobacco.basic.variety.desc')"/>
...
<script>
  import AddForm from './varietyAdd.vue';
  import EditForm from './varietyEdit.vue';
  ...
  export default {
    ...
    methods: {
      ...
      deleteButtonClick() {
        ...
        Promise.all([varietyApi.deleteVariety(this.formData.selectRow.id)])
          .then(([response]) => {
            this.$message({
              type: 'info',
      ...
      onSearchButtonClick() {
        Promise.all([varietyApi.getAll({
          ...
          .then(([response]) => {
            this.formData.varietyList = response.content;
