  ...
  <div class='mainPanel'>
    <div class='toolPanel'>
      ...
      <div class='toolButton'
        ...
        <el-button-group>
          ...
          <el-button type='primary'
                     @click='childForm.importForm=true'>{{ $t('base.import') }}</el-button>
          <el-button type='primary'
    ...
    <main class='contentPanel'>
      <el-table highlight-current-row
                ...
                :data="formData.cardList"
                style="width: 100%"
                :row-class-name="tableRowClassName">
        <el-table-column type="index">
        </el-table-column>
        <el-table-column prop="id"
                         :label="this.$t('tobacco.basic.card.isn')"
                         width="200"
        ...
        <el-table-column prop="barcode"
                         :label="this.$t('tobacco.basic.card.barcode')"
                         width="100"
                         show-overflow-tooltip />
        <el-table-column prop="content"
                         :label="this.$t('tobacco.basic.card.content')"
                         width="100"
                         show-overflow-tooltip />
        <el-table-column prop="date"
                         :label="this.$t('tobacco.basic.card.date')"
                         width="150"
                         show-overflow-tooltip />
        <el-table-column prop="model"
                         :label="this.$t('tobacco.basic.card.model')"
                         width="100"
                         show-overflow-tooltip />
        <el-table-column prop="number"
                         :label="this.$t('tobacco.basic.card.number')"
                         width="100"
                         show-overflow-tooltip />
        <el-table-column prop="serial"
                         :label="this.$t('tobacco.basic.card.serial')"
                         width="100"
                         show-overflow-tooltip />
        <el-table-column prop="type"
                         :label="this.$t('tobacco.basic.card.type')"
                         width="100"
                         show-overflow-tooltip />
        <el-table-column prop="usage"
                         :label="this.$t('tobacco.basic.card.usage')"
                         width="100"
                         show-overflow-tooltip />
        <el-table-column prop="valid"
                         :label="this.$t('tobacco.basic.card.valid')"
                         width="100"
                         show-overflow-tooltip />
        <el-table-column prop="desc"
                         :label="this.$t('tobacco.basic.card.desc')"
                         width="100"
                         show-overflow-tooltip />
    ...
    <template>
      ...
      <el-dialog :title="$t('base.import')"
                 :visible.sync="childForm.importForm"
                 top="10px"
                 :before-close="handleClose">
