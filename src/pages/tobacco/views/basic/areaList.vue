  ...
  <div class='mainPanel'>
    ...
    <main class='contentPanel'>
      <el-table
        ...
        :data="formData.areaList"
        style="width: 100%"
        :row-class-name="tableRowClassName">
        <el-table-column
          type="index">
        </el-table-column>
        <el-table-column prop="areaId" :label="this.$t('tobacco.basic.area.areaId')"/>
        <el-table-column prop="name" :label="this.$t('tobacco.basic.area.name')"/>
        <el-table-column prop="visible" :label="this.$t('tobacco.basic.area.visible')"/>
        <el-table-column prop="desc" :label="this.$t('tobacco.basic.area.desc')"/>
...
<script>
  import AddForm from './areaAdd.vue';
  import EditForm from './areaEdit.vue';
  ...
  export default {
    ...
    methods: {
      ...
      deleteButtonClick() {
        ...
        Promise.all([areaApi.deleteArea(this.formData.selectRow.id)])
          .then(([response]) => {
            this.$message({
              type: 'info',
