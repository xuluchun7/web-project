    ...
    <main class='contentPanel'>
      <el-table highlight-current-row
        ...
        <el-table-column prop="typeId"
                         :label="this.$t('tobacco.basic.part.typeId')" />
        <el-table-column prop="partId"
                         :label="this.$t('tobacco.basic.part.partId')" />
        <el-table-column prop="code"
                         :label="this.$t('tobacco.basic.part.code')" />
        <el-table-column prop="name"
                         :label="this.$t('tobacco.basic.part.name')" />
        <el-table-column prop="visible"
                         :label="this.$t('tobacco.basic.part.visible')" />
        <el-table-column prop="desc"
                         :label="this.$t('tobacco.basic.part.desc')" />
