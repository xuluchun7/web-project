  ...
  <div class='mainPanel'>
    ...
    <main class='contentPanel'>
      <el-table
        ...
        :data="formData.partList"
        style="width: 100%"
        :row-class-name="tableRowClassName">
        <el-table-column
          type="index">
        </el-table-column>
        <el-table-column prop="typeId" :label="this.$t('tobacco.basic.part.typeId')"/>
        <el-table-column prop="partId" :label="this.$t('tobacco.basic.part.partId')"/>
        <el-table-column prop="code" :label="this.$t('tobacco.basic.part.code')"/>
        <el-table-column prop="name" :label="this.$t('tobacco.basic.part.name')"/>
        <el-table-column prop="visible" :label="this.$t('tobacco.basic.part.visible')"/>
        <el-table-column prop="desc" :label="this.$t('tobacco.basic.part.desc')"/>
...
<script>
  import AddForm from './partAdd.vue';
  import EditForm from './partEdit.vue';
  ...
  export default {
    ...
    methods: {
      ...
      deleteButtonClick() {
        ...
        Promise.all([partApi.deletePart(this.formData.selectRow.id)])
          .then(([response]) => {
            this.$message({
              type: 'info',
