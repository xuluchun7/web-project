<template>
  <el-form :model="formItem"
    ...
    <el-form-item :label="$t('tobacco.basic.price.annual')"
                  prop="annual">
    ...
    <el-form-item :label="$t('tobacco.basic.price.payId')"
                  prop="pay">
      <el-input v-bind:placeholder="$t('base.pleaseInput')"
                v-model="formItem.pay" />
    </el-form-item>
    <el-form-item :label="$t('tobacco.basic.price.areaId')"
                  prop="area">
    ...
    <el-form-item :label="$t('tobacco.tsell.invoice.statusName')">
      <status-select :label.sync="formItem.status"
    ...
    <el-form-item :label="$t('tobacco.basic.price.price')"
                  prop="price">
      <el-input-number v-bind:placeholder="$t('base.pleaseInput')"
                       v-model="formItem.price"
                       style="width: 100%" />
    </el-form-item>
    <el-form-item :label="$t('tobacco.basic.price.supportFee')"
                  prop="supportfee">
      <el-input-number v-bind:placeholder="$t('base.pleaseInput')"
                       v-model="formItem.supportfee"
                       style="width: 100%" />
    </el-form-item>
    <el-form-item :label="$t('tobacco.basic.price.subsidy')"
                  prop="subsidy">
      <el-input-number v-bind:placeholder="$t('base.pleaseInput')"
  ...
  methods: {
    ...
    onSubmitClick(name) {
      this.$refs[name].validate(valid => {
        if (valid) {
          Promise.all([priceApi.savePrice(this.formItem)])
            .then(([response]) => {
