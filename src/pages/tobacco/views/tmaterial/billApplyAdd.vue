  ...
  <div>
    <el-form :model="formItem"
      ...
      <el-form-item style="width: 100%"
                    label-width="0px">
        <el-table :data="showMaterialDetailsArr"
                  tooltip-effect="dark"
    ...
    <el-dialog :title="$t('tobacco.tmaterial.billApply.materialDetails')"
               :visible.sync="showMaterialDetails"
               append-to-body>
...
export default {
  ...
  methods: {
    onSubmitClick(name) {
      ...
      this.formItem.lead = this.userOrgId.substring(
        0,
        this.userOrgId.length - 2
      );
      ...
      for (let i in this.formItem.billApplyItemList) {
        this.formItem.billApplyItemList[i].materialId = this.materialDetails[
          i
        ].id;
        this.formItem.billApplyItemList[i].materialName = this.materialDetails[
          i
        ].name;
        this.formItem.billApplyItemList[i].materialCode = this.materialDetails[
          i
        ].code;
        this.formItem.billApplyItemList[
          i
        ].materialNumber = this.materialDetails[i].barcode;
        this.formItem.billApplyItemList[i].measure = this.materialDetails[
          i
        ].measure.id;
        this.formItem.billApplyItemList[i].category = this.materialDetails[
          i
        ].category.id;
    ...
    currentChange(page) {
      this.showMaterialDetailsArr = this.materialDetails.filter(
        (item, index) => {
