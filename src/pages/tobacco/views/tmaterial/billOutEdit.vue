  ...
  <el-form :model="formItem"
    ...
    <el-form-item :label="$t('tobacco.tmaterial.bill.deliveryOrganizationName')"
      ...
      <organization-form :root="userOrgId"
                         ...
                         :placeholder="formItem.deliveryOrganizationName" />
    </el-form-item>

    <el-form-item :label="$t('tobacco.tmaterial.bill.grantObject')"
      ...
      <organization-form :root="userOrgId"
                         ...
                         :placeholder="formItem.arriveOrganizationName" />
    </el-form-item>
  ...
  methods: {
    load() {
      ...
      if (this.item) {
        ...
        if (!this.formItem.deliver) this.formItem.deliver = this.userName;
        if (!this.formItem.author) this.formItem.author = this.userName;
      } else {
