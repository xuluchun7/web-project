  ...
  <div class='mainPanel'>
    <div class='toolPanel'>
      <div class='queryCriteria'>
        <el-form inline>
          <el-form-item :label="$t('tobacco.tmaterial.pay.name')">
            <el-input v-bind:placeholder="$t('base.pleaseInput')"
                      v-model="searchData.name"
                      @keyup.enter.native="onSearchButtonClick" />
          </el-form-item>
          <el-form-item :label="$t('tobacco.tmaterial.pay.desc')">
            <el-input v-bind:placeholder="$t('base.pleaseInput')"
    ...
    <main class='contentPanel'>
      <el-table highlight-current-row
        ...
        <el-table-column prop="name"
                         :label="this.$t('tobacco.tmaterial.pay.name')" />
        <el-table-column prop="desc"
                         :label="this.$t('tobacco.tmaterial.pay.desc')" />
...
<script>
const AddForm = () => import("./payAdd.vue");
const EditForm = () => import("./payEdit.vue");
import payApi from "../../api/tmaterial/apiPay";
export default {
  data() {
    return {
      childForm: {
  ...
  methods: {
    ...
    deleteButtonClick() {
      ...
      Promise.all([payApi.softDelete(this.formData.selectRow.id)])
        .then(([response]) => {
          this.$message({
            type: "info",
    ...
    onSearchButtonClick() {
      Promise.all([
        payApi.getAll({
          ...
          search: "name:EQ:{name};desc:EQ:{desc};".format({
