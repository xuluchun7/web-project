...
//====获取LODOP对象的主过程：====
lodoputil.getLodop = function(oOBJECT, oEMBED) {
  var strHtmInstall =
  ...
  var LODOP;
  alert('是否需要云打印:' + lodoputil.needCLodop());
  try {
    var isIE =
