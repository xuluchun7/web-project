  ...
  <div class='mainPanel'>
    <div class='toolPanel'>
      ...
      <div class='toolButton'
        ...
        <el-button-group>
          <el-button plain
                     type='primary'
                     @click='searchButtonClick'>{{ $t('base.buttonSearch') }} </el-button>
          <el-button plain
                     type='primary'
    ...
    <main class='contentPanel'>
      <el-table highlight-current-row
        ...
        <el-table-column :label="$t('menu.style')"
                         width="60">
        </el-table-column>
        <el-table-column :label="$t('menu.templet')"
                         show-overflow-tooltip
                         width="100">
        </el-table-column>
        ...
        <el-table-column :label="$t('menu.cache')"
                         width="60">
          <template slot-scope="scope">
            <el-checkbox v-model="scope.row.cacheMenu"
                         disabled />
          </template>
        </el-table-column>
...
export default {
  ...
  methods: {
    ...
    deleteButtonClick() {
      ...
      if (
        this.formData.selectRow.child !== null &&
        this.formData.selectRow.child !== undefined &&
        this.formData.selectRow.child.length > 0
      ) {
        this.$message({
    ...
    searchButtonClick() {
      ...
      Promise.all([
        menuApi.getAll({
          ...
          contains:
            "code,title,shortTitle,url,path:" +
            this.formData.pagination.keyword,
          sort: "code",
          search: search
        })
      ])
