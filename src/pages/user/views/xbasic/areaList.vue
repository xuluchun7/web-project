    ...
    <main class='contentPanel'>
      <el-table highlight-current-row
        ...
        <el-table-column prop="countryId"
                         :label="this.$t('xbasic.area.countryId')" />
        <el-table-column prop="areaId"
                         :label="this.$t('xbasic.area.areaId')" />
        <el-table-column prop="prefix"
                         :label="this.$t('xbasic.area.prefix')" />
        <el-table-column prop="name"
                         :label="this.$t('xbasic.area.name')" />
        <el-table-column prop="depth"
                         :label="this.$t('xbasic.area.depth')" />
        <el-table-column prop="ext"
                         :label="this.$t('xbasic.area.ext')" />
        <el-table-column prop="desc"
                         :label="this.$t('xbasic.area.desc')" />
...
<script>
const AddForm = () => import("./areaAdd.vue");
const EditForm = () => import("./areaEdit.vue");
