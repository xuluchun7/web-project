  ...
  <div style="display: inherit">
    ...
    <el-table row-key="index"
      ...
      <el-table-column prop="filed"
        ...
        <template slot-scope="scope">
          <template v-if="scope.row._edit">
            <el-input v-model="scope.row.filed"
                      clearable
      ...
      <el-table-column prop="isPrimary"
        ...
        <template slot-scope="scope">
          <template v-if="scope.row._edit">
            <el-switch v-model="scope.row.isPrimary"></el-switch>
          </template>
      ...
      <el-table-column prop="notNull"
        ...
        <template slot-scope="scope">
          <template v-if="scope.row._edit">
            <el-switch v-model="scope.row.notNull"></el-switch>
          </template>
      ...
      <el-table-column prop="columnUnique"
        ...
        <template slot-scope="scope">
          <template v-if="scope.row._edit">
            <el-switch v-model="scope.row.columnUnique"></el-switch>
          </template>
...
export default {
  ...
  methods: {
    load() {
      ...
      this.thisDataTable = [];
      Promise.all([formApi.getPropertyList(this.tableId)])
        .then(([response]) => {
          for (var item of response) {
            item._edit = true;
            this.thisDataTable.push(item);
          }
        })
        .catch(error => {});
    },
