...
<template>
  <div style="display: inherit">
    ...
    <el-table row-key="index"
      ...
      <el-table-column prop="foreignName"
                       :label="$t('onlineForm.foreignName')">
        <template slot-scope="scope">
          <el-input v-if="scope.row._edit"
                    v-model="scope.row.foreignName"
                    clearable></el-input>
          <span v-else> {{ scope.row.foreignName}}</span>
        </template>
      </el-table-column>

      <el-table-column prop="foreignKey"
                       :label="$t('onlineForm.foreignKey')">
        <template slot-scope="scope">
          <el-input v-if="scope.row._edit"
      ...
      <el-table-column prop="foreignColumnName"
                       :label="$t('onlineForm.foreignColumnName')">
        <template slot-scope="scope">
          <el-input v-if="scope.row._edit"
      ...
      <el-table-column prop="foreignClass"
                       :label="$t('onlineForm.foreignClass')">
        <template slot-scope="scope">
          <el-select v-if="scope.row._edit"
                     v-model="scope.row.foreignClass"
                     clearable
                     filterable
                     allow-create
                     default-first-option>
            <el-option v-for="item in foreignEntityList"
                       :key="item"
                       :label="item"
                       :value="item">
            </el-option>
      ...
      <el-table-column prop="foreignType"
                       :label="this.$t('onlineForm.foreignType')">
        <template slot-scope="scope">
          <el-select v-if="scope.row._edit"
                     v-model="scope.row.foreignType">
            <el-option v-for="item in  formData.foreignTypeList"
                       :key="item"
                       :label="item"
                       :value="item" />
          </el-select>
      ...
      <el-table-column prop="fetchType"
                       :label="this.$t('onlineForm.fetchType')">
        <template slot-scope="scope">
          <el-select v-if="scope.row._edit"
                     v-model="scope.row.fetchType">
            <el-option v-for="item in  formData.fetchTypeList"
                       :key="item"
                       :label="item"
                       :value="item" />
          </el-select>
